...
function progressRequest({ key, cd }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const url = new URL((_a = options === null || options === void 0 ? void 0 : options.url) === null || _a === void 0 ? void 0 : _a.replace('/info', '/success'));
        const { host, protocol, pathname, search } = url;
        const query = Object.assign(querystring_1.default.parse(search === null || search === void 0 ? void 0 : search.replace('?', '')), { key, cd });
