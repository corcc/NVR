...
exports.failureRequest = void 0;
const util_1 = require("../../util");
const querystring_1 = __importDefault(require("querystring"));
function failureRequest({ key, cd, code }) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const harEntry = yield (0, util_1.loadHarEntryByUrl)('/info');
        let options = harEntry.request;
        const url = new URL((_a = options === null || options === void 0 ? void 0 : options.url) === null || _a === void 0 ? void 0 : _a.replace('/info', '/failure'));
...
exports.failureRequest = failureRequest;
// failureRequest({
// 	key: string
// });
